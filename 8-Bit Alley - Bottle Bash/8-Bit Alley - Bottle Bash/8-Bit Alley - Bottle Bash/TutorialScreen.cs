...
namespace _8_Bit_Alley___Bottle_Bash
{
    class TutorialScreen : Scene
    {
        ...
        Button _backButton = new Button(new Vector2(50, 240), SceneManager.Scenes.MENU, "Back To Menu", true);
        ...
        public override void Draw(SpriteBatch _spriteBatch)
        {
                ...
                _spriteBatch.Draw(_page1, Vector2.Zero, null, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0.07f);
